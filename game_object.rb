...
class GameObject
  ...
  def changeDir(dir)
    ...
    if(dir == Direction::Down and !isValid?(0, @TILESIZE-8))
      return false
    elsif(dir == Direction::Left and !isValid?(8-@TILESIZE, 0))
      return false
    elsif(dir == Direction::Up and !isValid?(0, 8-@TILESIZE))
      return false
    elsif(dir == Direction::Right and !isValid?(@TILESIZE-8, 0))
      return false
    end
    @dir = dir
  end
